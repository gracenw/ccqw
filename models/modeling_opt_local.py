...
class OPTAttention(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.sdpa = ScratchSDPAMasked(self.num_heads, self.head_dim, self.embed_dim)
    ...
    def forward(
        ...
        batch_size, seq_length = query_states.shape[:2]
        ...
        attn_output = self.sdpa(query_states, key_states, value_states, None, self.layer_idx)
